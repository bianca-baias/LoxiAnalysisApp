...
class AnalysisWindow(QMainWindow):
    def __init__(self, home_window):
        ...
        self.layout.addWidget(self.table, 3, 0, 1, 3, Qt.AlignmentFlag.AlignCenter)
        ...
        self.file_path = None
        self.layout.addWidget(self.file_path_label, 0, 1)
        
        self.status_label = QLabel("")
        self.layout.addWidget(self.status_label, 2, 0, 1, 3, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        self.layout.addWidget(self.start_analysis, 1, 0, 1, 3, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.layout.addWidget(self.start_new, 4, 2)
